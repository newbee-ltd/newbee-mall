...
public class ReviewController {
	...
	@ResponseBody
	public Result helpNum(@RequestBody ReviewSannkou reviewSannkou) {

		boolean insertHN = reviewService.insertHelpNum(reviewSannkou);
		if (insertHN) {
			boolean updateHN =reviewService.updateReviewNum(reviewSannkou);
			if (updateHN) {
