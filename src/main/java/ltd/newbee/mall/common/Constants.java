...
public class Constants {
	// public final static String FILE_UPLOAD_DIC =
	// "/opt/image/upload/";//上传文件的默认url前缀，根据部署设置自行修改
	public final static String FILE_UPLOAD_DIC = "/Users/chenghongzhen/fork/newbee-mall/src/main/resources/upload/";// 上传文件的默认url前缀，根据部署设置自行修改
