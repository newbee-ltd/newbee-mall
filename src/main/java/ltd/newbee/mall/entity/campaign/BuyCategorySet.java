...
public class BuyCategorySet {
	...
	public long getBuyCategoryId() {
		return buyCategoryId;
	}
	public void setBuyCategoryId(long buyCategoryId) {
		this.buyCategoryId = buyCategoryId;
	}
